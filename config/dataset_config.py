...
dataset_config = {
    ...
    'ava_v2.2':{
        ...
        'frame_list': 'frame_lists_yowo/', #liu
        # 'annotation_dir': 'annotations/',
        'annotation_dir': 'annotations_action+activate+pregnancy/', #liu
        # 'train_gt_box_list': 'ava_v2.2/ava_train_v2.2.csv',
        'train_gt_box_list': 'ava_train_v2.2.csv', #liu
        # 'val_gt_box_list': 'ava_v2.2/ava_val_v2.2.csv',
        'val_gt_box_list': 'ava_val_v2.2.csv', #liu
        # 'train_exclusion_file': 'ava_v2.2/ava_train_excluded_timestamps_v2.2.csv',
        'train_exclusion_file': 'ava_train_excluded_timestamps_v2.2.csv', #liu
        # 'val_exclusion_file': 'ava_v2.2/ava_val_excluded_timestamps_v2.2.csv',
        'val_exclusion_file': 'ava_val_excluded_timestamps_v2.2.csv', #liu
        # 'labelmap_file': 'ava_v2.2/ava_action_list_v2.2_for_activitynet_2019.pbtxt', # 'ava_v2.2/ava_action_list_v2.2.pbtxt',
        'labelmap_file': 'ava_action_list_v2.2_for_activitynet_2019.pbtxt', # 'ava_v2.2/ava_action_list_v2.2.pbtxt', #liu
        ...
        'valid_num_classes': 24,
        'label_map': (
                    "Continued lying", 'Continued standing', 'Continued sitting', "Continued prone","Walking", "Climbing","Rubbing"
                    ,"Continued bipedal standing", "Drinking","Eating","Locomotive","Resting","Exploring","Playing","Marking","Excretion"
                    ,"Grooming","Pregnancy grasping", "Lick the chest and abdomen","Lick the vulva","Curl up","Rub Yin","Roll","Run" #24
                ),
    },

    'jhmdb21':{
        # dataset
        'data_root': 'C:/jiang/YOWOv2/dataset/jhmdb21',
