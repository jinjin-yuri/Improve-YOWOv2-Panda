...
def parse_args():
    ...
    parser.add_argument('-v', '--version', default='yowo_v2_tiny', type=str,
                        help='build YOWOv2')
    parser.add_argument('--weight', default=r'C:\jiang\YOWOv2\weights\jhmdb21\222\yowo_v2_tiny_epoch_3.pth',
                        type=str, help='Trained state_dict file path to open')
...
def ava_eval(args, d_cfg, model, transform, collate_fn):
    # data_dir = os.path.join(args.root, 'AVA_Dataset') # 原代码
    data_dir = os.path.join(args.root)  # liu
