...
def evaluate_frameAP(gtFolder, detFolder, threshold=0.5, savePath=None, datatset='ucf24', show_pr_curve=False):
    ...
    gtFolder ='C:/jiang/YOWOv2/evaluator/groundtruths_ucf_jhmdb/groundtruths_jhmdb/'
...
if __name__ == '__main__':
    evaluate_frameAP(r"C:\jiang\YOWOv2\evaluator\groundtruths_ucf_jhmdb\groundtruths_ucf",
                     r"C:\jiang\YOWOv2\results\ucf_detections\yowo_v2_tiny\detections_1",
                     savePath='./evaluator/eval_results/')
