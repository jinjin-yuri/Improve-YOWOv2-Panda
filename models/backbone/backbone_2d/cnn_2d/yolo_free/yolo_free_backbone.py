...
# ======================  ELAN-Net ==========================
# ELANNet
from models.backbone.backbone_2d.cnn_2d.yolo_free.CBAM import CBAM
from models.backbone.backbone_2d.cnn_2d.yolo_free.dca import DCA
from models.backbone.backbone_2d.cnn_2d.yolo_free.triple import TripletAttention
from models.backbone.backbone_2d.test2d import origin_2d, two_2d, jingtai_2d, dongtai_2d
from models.yowo.encoder import att_2d
from models.yowo.scsa import SCSA


# from models.backbone.backbone_2d.cnn_2d.yolo_free.ECAAttention import ECAAttention
# from models.backbone.backbone_2d.cnn_2d.yolo_free.EMA import EMA
...
class ELANNet_Large(nn.Module):
    ...
    def forward(self, x):
        c1 = self.layer_1(x)  # [1,64,112,112]
        c2 = self.layer_2(c1) # [1,256,56,56]
        c3 = self.layer_3(c2) # [1,512,28,28]
        c4 = self.layer_4(c3) # [1,1024,14,14]
        c5 = self.layer_5(c4) # [1,1024,7,7]
