...
from models.backbone.backbone_3d.dwt import EnhancedSpectralSE
from models.backbone.backbone_3d.test_attention import CBAMAttention, ECAAttention, SEAttention, SpatialAttention
from models.basic.MLSA import MLSA
from models.basic.pinyuself import pinyu
...
class ShuffleNetV2(nn.Module):
    def __init__(self, width_mult='1.0x', num_classes=600):
        ...
        self.attn_block = MLSA(dim=self.stage_out_channels[-1])
        # self.attn_block = SEAttention(dim=self.stage_out_channels[-1])
