...
class DDSCSA(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        attn_2 = (attn_avg+attn_max) / 2
        attn = self.ca_gate(attn_2)
        return attn * x


if __name__ == "__main__":
    scsa = DDSCSA(dim=32, head_num=8, window_size=7)
