...
class KernelSpatialModulation_Global(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, groups=1, reduction=0.0625, kernel_num=4, min_channel=16,
        ...
        # self.bn = nn.Identity()
        self.bn = nn.Identity()          # nn.BatchNorm2d(attention_channel) jiang
...
if __name__ == '__main__':
    ...
    model = FDConv(in_channels=64, out_channels=64, kernel_size=3, padding=1, bias=False)
    # print(model)
    print("微信公众号: jiang缝合术!")
